...
<body>
    <div class="container py-5">
        <h1 class="mb-3">PHP - Badwords censored</h1>

        <div class="mb-4 bg-primary p-3 rounded-2">

            <div class="mb-5 bg-dark-subtle   rounded-2 p-2">
                <h2>
                    Paragrafo originale:
                </h2> 
                <p>
            ...
            <div class="mb-3 bg-danger rounded-2 p-2  ">
                <h2>
                    Parola da censurare:
                </h2>
        ...
        <div class="mb-3">
            ...
            <p class=" bg-success rounded-2 border-2 p-3 rounded-3  ">
                <?php 
